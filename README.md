...
Ensure you are using the correct version of node. The current version can be found in the [.nvmrc file](.nvmrc).
If you have nvm installed, you can just run `nvm use`.

You need credentials for the frontend account to run the tests.
Export the credentials by running `export AWS_PROFILE=frontend`
